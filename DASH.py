...
class DASH_GUI_v1:
    def __init__(self, master=None):
        ...
        self.btnLeft.configure(command=lambda:DASH_support.bLeft(1))
        ...
        self.btnLeft.bind('<Key-Left>',lambda e:DASH_support.lft(e))
        self.btnLeft.bind('<KeyRelease>',lambda e:DASH_support.stop(1))
        ...
        self.btnRvs.configure(command=lambda:DASH_support.bRvrs(1))
        ...
        self.btnRight.configure(command=lambda:DASH_support.bRight(1))
        ...
        self.goBtn.configure(command=lambda: DASH_support.goDASH(self.txtCommand.get()))
